    ...
    <div className={cn("relative pt-3", className)}>
      <div className="relative">
        ...
        <div className="relative overflow-hidden w-full rounded-xl aspect-video">
          <Image
            src={imageUrl || ThumbnailFallback}
            alt={title}
      ...
      {/* Video Count */}
      <div className="absolute bottom-2 right-2 px-1 py-0.5 rounded bg-black/80 text-white text-xs font-medium flex items-center gap-1">
